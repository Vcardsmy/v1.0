<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
    ...
    <div class="aside-logo flex-column-auto h-75px" id="kt_aside_logo">
        <a data-turbo="false" href="{{ url('/#home') }}" class="d-flex align-items-center flex-column mx-auto">
            <img class="navbar-brand-minimized brand-logo logo w-100 h-100" src="{{ getLogoUrl() }}" width="70px"
                 height="30px" alt="Logo"/>
            <span class="navbar-brand-name text-white logo mt-2"><b>{{ getAppName() }}</b></span>
        </a>
