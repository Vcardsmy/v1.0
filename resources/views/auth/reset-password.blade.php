...
@section('content')
    ...
    <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
        <a href="{{ route('users.index') }}" class="mb-12">
        ...
        <div class="w-lg-500px bg-white rounded shadow-sm p-10 p-lg-15 mx-auto">
            ...
            @csrf
                ...
                <!-- Password -->
                <div class="fv-row mb-10">
                    <label class="form-label fw-bolder text-dark fs-6 mb-0" for="password">{{__('messages.user.password')}}</label>
                ...
                <div class="fv-row mb-5">
                    <label class="form-label fw-bolder text-dark fs-6" for="password_confirmation">{{__('messages.user.confirm_password')}}</label>
