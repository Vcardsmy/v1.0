...
{{--                                <div class="reviews d-flex justify-content-sm-start justify-content-center ms-auto">--}}
                ...
                <div class="card qr-code-card flex-sm-row flex-column justify-content-center align-items-center mt-3 border-0">
                    <div class="mx-2">
                        <div class="qr-profile mb-3 d-flex justify-content-center">
                            <img src="{{asset('assets/img/vcard3/testimonial-profile.png')}}" alt="qr profile" class="mx-auto d-block rounded-circle"/>
                        </div>
                        <button type="button" class="qr-code-btn text-white mt-4 mx-auto d-sm-block d-none">Download My QR Code</button>
                    </div>
