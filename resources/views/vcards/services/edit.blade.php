            ...
            <div class="modal-body mx-7">
                ...
                <div class="row mb-5">
                    <div class="col-sm-12 mb-5">
                        ...
                        {{ Form::text('name', null, ['class' => 'form-control form-control-solid', 'id' => 'editName', 'required', 'placeholder' => __('messages.form.service')]) }}
                    </div>
                    <div class="col-sm-12 mb-5">
                    ...
                    <div class="col-sm-12 mb-5">
                        ...
                        <div class="image-input image-input-outline" data-kt-image-input="true">
                            <img class="image-input-wrapper w-125px h-125px rounded-circle" id="editServicePreview"
                        ...
                        <div class="form-text text-danger" id="editServiceIconValidation"></div>
                    </div>
                    <div class="d-flex">
