    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title">{{ __('messages.vcard.new_service') }}</h2>
            ...
            <div class="modal-body mx-7">
                ...
                <div class="row mb-5">
                    <div class="col-sm-12 mb-5">
                        ...
                        {{ Form::text('name', null, ['class' => 'form-control form-control-solid','required', 'placeholder' => __('messages.form.service')]) }}
                    </div>
                    <div class="col-sm-12 mb-5">
                    ...
                    <div class="col-sm-12 mb-5">
                        <div class="mb-3">
                            <label class="form-label required fs-6 fw-bolder text-gray-700">{{ __('messages.vcard.service_icon').':' }}</label>
                        </div>
                        <div class="image-input image-input-outline" data-kt-image-input="true">
                            <img class="image-input-wrapper w-125px h-125px rounded-circle" id="servicePreview"
                        ...
                        <div class="form-text text-danger" id="serviceIconValidationErrors"></div>
                    </div>
                    <div class="d-flex">
