        ...
        <div class="modal-content">
            ...
            <div class="modal-body mx-7">
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-sm-12 mb-5 mt-3 editImagelink">
                        ...
                        <div class="image-input image-input-outline" data-kt-image-input="true">
                            <img class="image-input-wrapper w-125px h-125px" id="editGalleryPreview"
                            ...
                            <span class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-white shadow edit-cancel-gallery"
                                  data-kt-image-input-action="cancel" disabled="disabled" data-bs-toggle="tooltip"
                                  data-bs-original-title="{{__('messages.tooltip.cancel_image')}}">
                                    <i class="bi bi-x fs-2"></i>
                            </span>
                        </div>
                        <div class="form-text text-danger" id="editGalleryValidationErrors"></div>
                    </div>
                </div>
                <div class="col-lg-12 mb-7 d-none editYouTubeLink">
                    ...
                    {{ Form::url('link', null, ['class' => 'form-control form-control-solid', 'placeholder' => 'https://www.youtube.com/watch?v=hAGbufevHM4','id'=>'editYouTube_Link']) }}
                </div>
                <div class="d-flex">
