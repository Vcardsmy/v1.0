    ...
    <div class="vcard-ten main-content w-100 mx-auto overflow-hidden">
            ...
            <div class="language pt-3 me-2">
                <ul class="text-decoration-none">
                    <li class="dropdown1 dropdown lang-list">
                        <a href="#" class="dropdown-toggle lang-head text-decoration-none" data-toggle="dropdown"
                           role="button"
        ...
        <div class="vcard-ten__profile-details py-4 px-3">
            <div class="social-icons d-flex justify-content-center pt-4">
                ...
                <i class="fab fa-instagram instagram-icon icon mx-sm-3 mx-2 fa-2x"></i>
                <i class="fab fa-linkedin-in linkedin-icon icon mx-sm-3 mx-2 fa-2x"></i>
                <i class="fab fa-whatsapp whatsapp-icon icon mx-sm-3 mx-2 fa-2x"></i>
...
{{--                                    <div class="reviews d-flex justify-content-sm-start justify-content-center mt-2">--}}
{{--                                        <i class="fas fa-star star-icon me-1"></i>--}}
{{--                                        <i class="fas fa-star star-icon mx-1"></i>--}}
{{--                                        <i class="fas fa-star star-icon mx-1"></i>--}}
{{--                                        <i class="fas fa-star star-icon mx-1"></i>--}}
{{--                                        <i class="far fa-star star-icon ms-1"></i>--}}
{{--                                    </div>--}}
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="card qr-code-card justify-content-center align-items-center px-sm-3 px-4 pt-5 pb-4 position-relative w-100 mx-auto shadow">
                    <div class="qr-profile mb-3 d-flex justify-content-center position-absolute top-0">
                        <img src="{{asset('assets/img/vcard3/testimonial-profile.png')}}" alt="qr profile" class="rounded-circle"/>
                    </div>
