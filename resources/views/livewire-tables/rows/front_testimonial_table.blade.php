        ...
        <div class="symbol symbol-circle symbol-50px overflow-hidden me-3 h-50px w-50px">
            <a>
                <div class="symbol-label">
                    <img src="{{ $row->testimonial_url }}" alt="" class="user-img w-100">
                </div>
            </a>
        </div>
...
<x-livewire-tables::bs5.table.cell>
    <div class="edit d-inline-block me-1">
        <a title="{{__('messages.common.edit')}}" href="javascript:void(0)"
           class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 front-testimonial-edit-btn" data-id="{{$row->id}}"
    ...
    <a title = "<?php echo __('messages.common.view') ?>"
       href="javascript:void(0)" data-id="{{ $row->id }}" class="btn view-testimonial-btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1"><i class="fas fa-eye"></i></a>
    
    <div class="delete d-inline-block">
        <a title="{{__('messages.common.delete')}}" href="javascript:void(0)" data-id="{{ $row->id }}"
           class="btn front-testimonial-delete-btn btn-icon btn-bg-light text-hover-danger btn-sm" data-turbolinks="false">
                        <span class="svg-icon svg-icon-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24"
                             version="1.1">
