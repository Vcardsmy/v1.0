...
<x-livewire-tables::table.cell>
    <a href="javascript:void(0)" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 service-edit-btn my-2"
       data-id="{{$row->id}}" title="<?php echo __('messages.common.edit') ?>">
    ...
    <a href="javascript:void(0)" title="<?php echo __('messages.common.delete'); ?>" data-id="{{$row->id}}"
       class="service-delete-btn btn btn-icon btn-bg-light text-hover-danger btn-sm my-2">
                        <span class="svg-icon svg-icon-3">
    ...
    <a title="<?php echo __('messages.common.view'); ?>"
       class="btn text-center btn-icon btn-bg-light text-hover-primary service-view-btn btn-sm ms-1"
