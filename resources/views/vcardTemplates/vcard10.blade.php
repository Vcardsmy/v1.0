...
<div class="container">
    ...
    <div class="vcard-ten main-content w-100 mx-auto overflow-hidden content-blur">
                        ...
                        <div class="col-sm-6 col-12">
                            ...
                            <span class="event-icon d-flex justify-content-center align-items-center">
                                ...
                                <div class="event-detail ms-sm-3 mt-sm-0 mt-4">
                                    ...
                                    <h5><a href="mailto:{{ $vcard->email }}" class="event-name text-sm-start text-center mb-0">{{ $vcard->email }}</a></h5>
                                </div>
                            </div>
                        </div>
                    @endif
                            ...
                            <span class="event-icon d-flex justify-content-center align-items-center">
                                ...
                                <div class="event-detail ms-sm-3 mt-sm-0 mt-4">
                                    ...
                                    <h5><a href="tel:{{ $vcard->phone }}"
                                           class="event-name text-sm-start text-center mb-0">+{{ $vcard->region_code }} {{ $vcard->phone }}</a>
                                    </h5>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row g-3 testimonial-slider mt-4">
                        @foreach($vcard->testimonials as $testimonial)
                            <div class="col-12">
                                <div class="card justify-content-between testimonial-card p-4 border-0 w-100 position-relative shadow">
        ...
        <div class="vcard-ten__qr-code py-4 px-sm-3 px-2 position-relative">
            ...
            <div class="container">
                <div
                    ...
                    <div class="mt-3 qr-code-scanner mx-md-4 mx-2 p-5 mb-8 bg-white">
                        {!! QrCode::size(130)->format('svg')->generate(Request::url()); !!}
                    </div>
                    <div class="mx-2">
                        <a class="qr-code-btn mt-4 mx-auto text-decoration-none"
