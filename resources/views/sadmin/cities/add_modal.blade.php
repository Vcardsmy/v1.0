    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title">{{ __('messages.city.new_city') }}</h2>
            ...
            <div class="modal-body mx-7">
                <div class="row mb-5">
                    ...
                    <div class="col-sm-12 mb-5">
                        ...
                        {{ Form::select('state_id', getState(), null, ['id' => 'StateCity', 'class' => 'form-select form-select-solid fw-bold','required', 'placeholder'=>__("messages.form.select_state"), 'data-control' => 'select2', 'data-dropdown-parent' => '#addCityModal']) }}
                    </div>
                </div>
