    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title">{{ __('messages.state.edit_state') }}</h2>
            ...
            <div class="modal-body mx-7">
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-sm-12 mb-5">
                        ...
                        {{ Form::select('country_id', getCountry(), null, ['class' => 'form-select form-select-solid fw-bold select2Selector','required', 'placeholder'=> __("messages.form.select_country"), 'data-control' => 'select2', 'data-dropdown-parent' => '#editStateModal', 'id' => 'editCountryId']) }}
                    </div>
                </div>
