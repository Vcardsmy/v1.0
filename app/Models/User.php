 ...
 * @property-read \Illuminate\Database\Eloquent\HigherOrderBuilderProxy|mixed $plan_name
 */
class User extends Authenticatable implements HasMedia, MustVerifyEmail
{
    ...
    {
        return $this->belongsTo(Subscription::class, 'tenant_id', 'tenant_id')->where('status', Subscription::ACTIVE);
    }
